app.controller('signInCtrl', ['$scope', '$rootScope', '$http', '$cookies', '$cookieStore', '$location', '$routeParams',
		function ($scope, $rootScope, $http, $cookies, $cookieStore, $location, $routeParams) {
			...
			$scope.signIn = function () {
				...
				.success(function (data, status, headers, config) {
					...
					window.location = './#/deputado/lista';
				})
