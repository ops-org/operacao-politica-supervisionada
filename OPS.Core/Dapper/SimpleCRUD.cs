...
{
    /// <summary>
    /// Main class for Dapper.SimpleCRUD extensions (Dapper.SimpleCRUD 2.3.0 - Mar 15, 2021)
    /// </summary>
    public static partial class SimpleCRUD
    {
        ...
        public static ResultFilter<T> GetListPaged<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            var result = new ResultFilter<T>();
            using (var multi = connection.QueryMultiple(query, parameters, transaction, commandTimeout))
            {
                result.Data = multi.Read<T>();
                result.RecordsTotal = multi.ReadSingle<int>();
        ...
        public static TKey Insert<TKey, TEntity>(this IDbConnection connection, TEntity entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            if ((keytype == typeof(int) || keytype == typeof(uint) || keytype == typeof(long) || keytype == typeof(ulong)) && Convert.ToInt64(idProps.First().GetValue(entityToInsert, null)) == 0)
            {
