...
{
    public class SenadorRepository : BaseRepository
    {
        ...
        private void AdicionaResultadoComum(DataTablesRequest request, StringBuilder sqlSelect, string defaultSort = "valor_total desc")
        {
