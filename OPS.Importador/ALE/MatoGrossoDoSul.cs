...
/// https://consulta.transparencia.al.ms.gov.br/
/// </summary>
public class MatoGrossoDoSul : ImportadorBase
{
    public MatoGrossoDoSul(IServiceProvider serviceProvider) : base(serviceProvider)
    {
