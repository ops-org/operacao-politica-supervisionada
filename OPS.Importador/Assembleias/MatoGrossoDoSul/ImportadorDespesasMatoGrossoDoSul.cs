...
using OPS.Importador.Assembleias.MatoGrossoDoSul.Entities;
...
public class ImportadorDespesasMatoGrossoDoSul : ImportadorDespesasRestApiAnual
{
    public ImportadorDespesasMatoGrossoDoSul(IServiceProvider serviceProvider) : base(serviceProvider)
    {
        config = new ImportadorCotaParlamentarBaseConfig()
        {
            ...
            Estado = Estados.MatoGrossoDoSul,
    ...
    public override async Task ImportarDespesas(IBrowsingContext context, int ano)
    {
        ...
        while (true)
        {
            ...
            document = await context.OpenAsync(req => req.Content("<div id='sc_grid_body'>" + html + "</div>"));
            //logger.LogDebug("Consultando pagina {Pagina}!", ++pagina);
