    ...
    <div data-ng-controller="FornecedorController">
      <div class="container">
        ...
        <div id="fsDadosReceita" class="form-group" v-if="fornecedor.genero==='pj'">
          ...
          <div
            id="dvInfoDataConsultaCNPJ"
            class="alert alert-warning"
            v-if="fornecedor.obtido_em"
          >
          ...
          <div class="row mb-2">
            ...
            <div class="col-md-12">
              <p class="mb-1">
                ...
                <span v-if="complemento">, {{fornecedor.complemento}}</span>
                  ...
                  <div class="form-group">
                    <table class="table table-condensed table-striped table-sm">
                      ...
                      <tbody v-if="quadro_societario.length>0">
                        <tr
                          v-for="row in quadro_societario"
                          :key="row.nome"
                        >
                          <td>{{row.nome}}</td>
      ...
      <div class="container-fluid">
        <div class="row form-group" data-ng-hide="DeputadoFederalMaioresGastos.length===0">
          <div class="col-xs-12 col-sm-6">
            <div class="card mb-3">
              ...
              <div class="card-body">
                <highcharts :options="chartRecebimentosPorMesDeputadosOptions" ref="chartRecebimentosPorMesDeputados"></highcharts>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6">
            <div class="card mb-3">
              <div class="card-header bg-light">
                <a
                  class="float-right"
                  v-bind:href="'./deputado-federal?Fornecedor='+fornecedor.id_cf_deputado+'&Periodo=0&Agrupamento=6'"
        ...
        <div class="row form-group" v-if="SenadoresMaioresGastos.length>0">
          <div class="col-xs-12 col-sm-6">
            <div class="card mb-3">
              <div class="card-header bg-light">Senadores - Recebimentos mensais</div>
              <div class="card-body">
                <highcharts :options="chartRecebimentosPorMesSenadoresOptions" ref="chartRecebimentosPorMesSenadores"></highcharts>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6">
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(`${process.env.API}/fornecedor/${this.id}/DeputadoFederalMaioresGastos`)
      .then((response) => {
    ...
    axios
      .get(`${process.env.API}/fornecedor/${this.id}/RecebimentosMensaisPorAnoDeputados`)
      .then((response) => {
        this.chartRecebimentosPorMesDeputadosOptions.series = response.data;
      });

    axios
      .get(`${process.env.API}/fornecedor/${this.id}/RecebimentosMensaisPorAnoSenadores`)
      .then((response) => {
