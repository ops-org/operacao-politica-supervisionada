                        ...
                        <Card className="overflow-hidden shadow-lg border-0 bg-card/50 backdrop-blur-sm group hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
                            <div className="aspect-video bg-muted relative rounded-t-xl overflow-hidden">
                                ...
                                <iframe
                                    width="540"
                                    height="303.75"
                                    src="https://www.youtube-nocookie.com/embed/JqO0_EhbJUw?si=smF8JoyCr9Bs4TQS"
                                    title="Fiscalizando com site da OPS (Tutorial 1)"
                                    frameborder="0"
                        ...
                        <Card className="overflow-hidden shadow-lg border-0 bg-card/50 backdrop-blur-sm group hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
                            <div className="aspect-video bg-muted relative rounded-t-xl overflow-hidden">
                                ...
                                <iframe
                                    width="540"
                                    height="303.75"
                                    src="https://www.youtube.com/embed/lcNf9gi2FdY?si=SludosPyfmIKcD71"
                                    title="Fiscalizando com site da OPS (Tutorial 2)"
                                    frameBorder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin"
                                    allowFullScreen
