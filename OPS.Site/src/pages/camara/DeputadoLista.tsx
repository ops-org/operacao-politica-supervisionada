            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-blue-600">Total de Deputados</p>
                      <p className="text-2xl font-bold text-blue-900">{stats.totalDeputados}</p>
                    </div>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-green-600">Deputados Ativos</p>
                ...
                <CardContent className="p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-shrink-0">
                      <div className="relative" data-image-id={deputado.id_cf_deputado}>
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        <Badge variant="secondary" className="font-semibold" title={deputado.nome_partido}>
                          {deputado.sigla_partido}
                        </Badge>
                        <Badge variant="outline" className="flex items-center gap-1" title={deputado.nome_estado}>
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-xs text-muted-foreground">Cota Parlamantar</span>
                        </div>
