...
export default {
  ...
  mounted() {
    ...
    axios
      .get('https://ops.net.br/api/Deputado/CamaraResumoMensal')
      .then((response) => {
    ...
    axios
      .get('https://ops.net.br/api/Senador/SenadoResumoMensal')
      .then((response) => {
    ...
    axios
      .get('https://ops.net.br/api/Deputado/CamaraResumoAnual')
      .then((response) => {
    ...
    axios
      .get('https://ops.net.br/api/Senador/SenadoResumoAnual')
      .then((response) => {
