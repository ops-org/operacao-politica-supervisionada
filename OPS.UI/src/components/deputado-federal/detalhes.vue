    ...
    <div class="container">
        ...
        <div class="row form-group">
            <div class="col-xs-12 col-md-4 col-lg-2 text-center">
                <img class="img-thumbnail img-responsive img-deputado" v-bind:src="'https://ops.net.br/api/deputado/imagem/' + id + '_120x160'" v-bind:alt="deputado_federal.nome_parlamentar" width="130" height="170" />
            </div>
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(`http://localhost:5000/api/deputado/${this.id}/GastosMensaisPorAno`)
      .then((response) => {
        this.chartDeputadoGastosPorMesOptions.series = response.data;
      });

    axios
      .get(`http://localhost:5000/api/deputado/${this.id}/ResumoPresenca`)
      .then((response) => {
    ...
    axios
      .get(`http://localhost:5000/api/deputado/${this.id}/MaioresNotas`)
      .then((response) => {
        this.MaioresNotas = response.data;
      });

    axios
      .get(`http://localhost:5000/api/deputado/${this.id}/MaioresFornecedores`)
      .then((response) => {
