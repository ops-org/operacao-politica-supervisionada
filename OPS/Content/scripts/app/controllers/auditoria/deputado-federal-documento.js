...
app.controller('DeputadoDocumentoVisualizarController', ["$scope", "$api", "$routeParams",
    function ($scope, $api, $routeParams) {
        ...
        $api.get('Deputado/Documento', $routeParams.id).success(function (doc) {
            ...
            $scope.documento.url_demais_documentos_mes = url_camara + 'sumarizado?nuDeputadoId=' + doc.id_deputado + '&dataInicio=' + doc.mes + '/' + doc.ano + '&dataFim=' + doc.mes + '/' + doc.ano + '&despesa=&nomeHospede=&nomePassageiro=&nomeFornecedor=&cnpjFornecedor=&numDocumento=&sguf=&filtroNivel1=1&filtroNivel2=2&filtroNivel3=3'
