...
namespace OPS.WebApi
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            //var Provider = identity.Claims.Where(c => c.Type == "Provider").Select(c => c.Value).SingleOrDefault();
            //var ExternalAccessToken = identity.Claims.Where(c => c.Type == "ExternalAccessToken").Select(c => c.Value).SingleOrDefault();
        ...
        private async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if (provider == "Facebook")
            {
                ...
                var appToken = WebConfigurationManager.AppSettings["FacebookAuthClientToken"];
