...
namespace OPS.WebApi
{
	...
	public class ContatoController : ApiController
	{
		[HttpPost]
		[ActionName("")]
		public async System.Threading.Tasks.Task<IHttpActionResult> PostAsync(JObject jsonData)
		{
			using (var objEmail = new MailMessage
			{
				IsBodyHtml = false,
				Subject = "[OPS] Contato - " + jsonData["name"],
		...
		//[HttpPost]
		//public IHttpActionResult SolicitarRestituicao(Newtonsoft.Json.Linq.JObject jsonData)
		//{
