        ...
        return {
            ...
            link: function (scope) {
                ...
                function configChanged() {
                    ...
                    $window.disqus_shortname = scope.config.disqus_shortname || 'ops-net-br';
                    $window.disqus_identifier = scope.config.disqus_identifier;
                    $window.disqus_url = scope.config.disqus_url || 'http://ops.net.br';
                    $window.disqus_title = scope.config.disqus_title || document.title;
